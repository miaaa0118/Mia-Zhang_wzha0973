...
function drawSecondBuilding() {
  ...
  function draw() {
    ...
    if (frameCount > 60 && Layer < 1) Layer = 1;
    if (frameCount > 120 && Layer < 2) Layer = 2;
    if (frameCount > 180 && Layer < 3) Layer = 3;
    if (frameCount > 240 && Layer < 4) Layer = 4; 
    if (frameCount > 300 && Layer < 5) Layer = 5; 
    if (frameCount > 360 && Layer < 6) Layer = 6; 
