...
function drawThirdBuilding() {
  push();
  translate(thirdSegStart, 0); // Set the starting position of the canvas to two-quarter of the screen
  ...
  function drawFourthBuilding() {
    push();
    translate(fourthSegStart, 0); // Set the starting position of the canvas to three-quarter of the screen
  ...
  function draw() {
    ...
    if (frameCount > 40 && Layer < 1) Layer = 1; // Show 1st layer after 40 frames
    if (frameCount > 80 && Layer < 2) Layer = 2; // Show 2nd layer after 80 frames
    if (frameCount > 120 && Layer < 3) Layer = 3; // Show 3rd layer after 120 frames
    if (frameCount > 160 && Layer < 4) Layer = 4; // Show 4th layer after 160 frames
    if (frameCount > 200 && Layer < 5) Layer = 5; // Show 5th layer after 200 frames
    if (frameCount > 240 && Layer < 6) Layer = 6; // Show 6th layer after 240 frames
    if (frameCount > 280 && Layer < 7) Layer = 7; // Show 7th layer after 280 frames
    if (frameCount > 320 && Layer < 8) Layer = 8; // Show 8th layer after 320 frames
