...
function drawThirdBuilding() {
  ...
  function draw() {
    ...
    if (frameCount > 40 && Layer < 1) Layer = 1; 
    if (frameCount > 80 && Layer < 2) Layer = 2; 
    if (frameCount > 120 && Layer < 3) Layer = 3; 
    if (frameCount > 160 && Layer < 4) Layer = 4; 
    if (frameCount > 200 && Layer < 5) Layer = 5; 
    if (frameCount > 240 && Layer < 6) Layer = 6; 
    if (frameCount > 280 && Layer < 7) Layer = 7; 
    if (frameCount > 320 && Layer < 8) Layer = 8; 
